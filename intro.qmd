...
model_rec <- recipe(class ~ ., data = sim_tr) %>% step_spline_b(A, B, deg_free = tune())
...
At this point, we need code for the user-interface and the plot results. Each is is very simple:
